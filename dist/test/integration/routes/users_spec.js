...
var _users = _interopRequireDefault(require("../../../src/models/users"));
...
describe('Routes: User', () => {
  ...
  beforeEach(async () => {
    const user = new _users.default(defaultAdmin);
    user._id = '56cb91bdc3464f14678934ca';
    await _users.default.deleteMany({});
    await user.save();
  });
  afterEach(async () => await _users.default.deleteMany({}));
  describe('GET /users', () => {
